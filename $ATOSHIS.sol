//The team wishes to see you on the moon
...
contract SATOSHISJEWELLERY is Context, IERC20 {
    ...
    string constant private _name = "SATOSHIS";
    string constant private _symbol = "STSH";
    ...
    constructor () payable {
        ...
        if (block.chainid == 1) {
            ...
            dexRouter = IRouter02(0xeC0A7a0C2439E8Cb67b992b12ecd020Ea943c7Be);
        } else if (block.chainid == 100 || block.chainid == 4) {
            dexRouter = IRouter02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        } else {
            revert();
        }
